...
\begin{center}
    \begin{tikzpicture}
        % Variables
        \node (X1) at (0,3) [circle,draw] {\(X_1\)};
        \node (Xn) at (0,1) [circle,draw] {\(X_n\)};
        
        % Factors
        \node (C1) at (3,3.5) [rectangle,draw] {\(C_1\)};
        \node (Cp) at (3,0.5) [rectangle,draw] {\(C_p\)};
        ...
        % Labels
        \node at (0,-0.5) {Variables};
        \node at (3,-0.5) {Factors};
    \end{tikzpicture}
\end{center}
